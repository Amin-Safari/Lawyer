...
<div>
    @if(session()->has('message'))
        <div class="alert alert-success alert-dismissible fade show animate__animated animate__fadeInDown mb-4" role="alert">
                        ...
                        <div class="d-flex justify-content-between align-items-center">
                            <div class="d-flex align-items-center">
                                <div class="skill-header-icon me-3">
                                    <div class="icon-wrapper rounded-circle d-flex align-items-center justify-content-center p-3"
                    ...
                    <div class="row g-4">
                        @foreach($lawyers as $lawyer)
                            <div class="col-md-6 col-xl-4">
                                <div class="card lawyer-card border-0 shadow-lg h-100 animate__animated animate__fadeInUp"
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="text-center mb-4">
                                            ...
                                            <div class="rating mb-3">
                                                ...
                                                @endfor
                                                <small class="text-muted ms-1">(۴.۲)</small>
                                            </div>
                                        </div>
                                        ...
                                        <div class="mb-4">
                                            ...
                                            <div class="info-item d-flex align-items-center mb-3">
                                                ...
                                                <div class="flex-grow-1">
                                                    <small class="text-muted d-block">سابقه فعالیت</small>
                                                    <span class="fw-semibold">{{ rand(3, 15) }} سال</span>
                                                </div>
                                            </div>
                                            <div class="info-item d-flex align-items-center">
                                                ...
                                                <div class="flex-grow-1">
                                                    <small class="text-muted d-block">هزینه تماس</small>
                                                    <span class="fw-bold text-danger">
                                                        {{ number_format($selectedSkill->click_price) }} ریال
                                                    </span>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="mb-4">
                                            ...
                                            <div class="d-flex flex-wrap gap-2">
                                                ...
                                                @if($lawyer->skills->count() > 4)
                                                    <span class="badge bg-secondary">+{{ $lawyer->skills->count() - 4 }}</span>
                                                @endif
                                            </div>
                                        </div>
    ...
    <script>
        ...
        function confirmCall(lawyerId) {
            if (confirm('آیا مایل به برقراری تماس با این وکیل هستید؟ هزینه از کیف پول شما کسر خواهد شد.')) {
